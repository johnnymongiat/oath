...
/**
 * Provides RFC 6238 test vectors used for the HOTP time-based variant algorithm
...
public final class RFC6238TestVectors {
    ...
    public static final class TestVector {
        ...
        /**
         * Returns the {@link HmacShaAlgorithm} used in generating the expected
         * TOTP.
         * 
         * @return the {@link HmacShaAlgorithm} used in generating the expected
         *         TOTP.
         */
        ...
        /**
         * Returns the test time (in milliseconds) used in generating the
         * expected TOTP.
         * 
         * @return the test time (in milliseconds) used in generating the
         *         expected TOTP.
         */
    ...
    /**
     * The test shared secret key (Base 32 encoded) used for TOTP based on
     * HMAC-SHA-256.
     */
    ...
    public static final Set<TestVector> TEST_VECTORS = ImmutableSet.<TestVector> builder()
            ...
            .add(new TestVector("47863826", TEST_TIME_SECONDS[5], HmacShaAlgorithm.HMAC_SHA_512, KEY_FOR_HMAC_SHA_512)).build();
