...
/**
 * Provides RFC 4226 test vectors used for the HOTP HMAC-based variant algorithm
...
public final class RFC4226TestVectors {
    ...
    public static final Set<TestVector> TEST_VECTORS = ImmutableSet.<TestVector> builder().add(new TestVector("755224", 0, KEY))
            .add(new TestVector("287082", 1, KEY)).add(new TestVector("359152", 2, KEY)).add(new TestVector("969429", 3, KEY))
            .add(new TestVector("338314", 4, KEY)).add(new TestVector("254676", 5, KEY)).add(new TestVector("287922", 6, KEY))
            .add(new TestVector("162583", 7, KEY)).add(new TestVector("399871", 8, KEY)).add(new TestVector("520489", 9, KEY)).build();
