 ...
 * <p>Refer to {@link TOTPBuilder} on how to generate a {@code TOTP}.</p>
 * 
...
public final class TOTP {
    ...
    /**
     * Creates a new instance of a Time-based one time password. Use the static method to obtain a {@link TOTPBuilder} instance and obtain a {@code TOTP} from that.
     * Note that all parameters are assumed to be valid since the {@link TOTPBuilder} is responsible for validation, and creation
     * of {@link TOTP}s.
     * 
     * @param code the time-based one time password
    ...
    /**
     * Returns a new {@link TOTPBuilder} instance initialised with the specified {@code key}.
     * 
