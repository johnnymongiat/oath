 ...
 * generation parameters. Once the HOTP configuration is prepared, the builder is used to generate an {@link HOTP} using the 
 * {@code build()} method:
 * </p>
 * <pre>
...
public final class HOTPBuilder {
	 ...
	 * 
	 * @return this {@code HOTPBuilder} instance initialised with the specified {@code movingFactor}.
	 * 
